        ...
        //if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            elseif ($profanity == true){
              ...
              mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT); // report errors
                ...
                $username = 'id20227990_admin';
                $dbname = 'id20227990_sffreedomwall';
                $password = '_4SIvGe>(cO/EPtS';
                ...
                echo "<script>window.location.replace('https://freedom-wall.000webhostapp.com/')</script>";
...
.loader {
  ...
  height: 100%;
  z-index: 9999;
  background: url(https://cdn.glitch.global/0b51df57-1a70-466d-b8be-650e7d370d4f/LogoSF.png?v=1674818301307)
